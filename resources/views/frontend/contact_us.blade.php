...
<body id="show-grid">
    ...
    {{-- <div class="contact-area overflow-hidden space" id="contact-sec">
     ...
     <div class="contact-area3 overflow-hidden space overflow-hidden" id="contact-sec"
        data-bg-src="{{ asset('demo/assets/img/bg/contact_bg_1.jpg')}}">
        <div class="container">
            <div class="row gy-4 justify-content-between">
                <div class="col-xl-4">
                    <div class="title-area"><span class="sub-title style2 text-anime text-white">get in touch</span>
                        <h2 class="sec-title style5 text-white split-text">Transforming Visions Into Reality</h2>
                    </div>
                </div>
                <div class="col-xl-6">
                    <form action="https://html.themehour.net/faren/demo/mail.php" method="POST"
                        class="contact-form3 ajax-contact">
                        <div class="row">
                            <div class="form-group col-md-6"><input type="text" class="form-control" name="name"
                                    id="name" placeholder="Full Name"> <i class="fa-solid fa-user"></i></div>
                            <div class="form-group col-md-6"><input type="email" class="form-control" name="email"
        ...
        <div class="shape-mockup spin d-none d-xxl-block" data-bottom="42%" data-left="14%"><img
                src="{{ asset('demo/assets/img/shape/element-8.png')}}" alt=""></div>
    </div>
